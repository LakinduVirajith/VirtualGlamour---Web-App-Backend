...
public class UserController {
    ...
    @Operation(
            ...
            description = "Deactivate a user account. you must login to the system first"
    )
    ...
    @Operation(
            summary = "Forgot Password OTP Email",
    ...
    @Operation(
            ...
            description = "Validate the provided OTP (One-Time Password) for reset password verification."
    )
    ...
    @Operation(
            ...
            description = "Initiate password reset by sending an OTP to the user's email. Authenticate with the OTP and set a new password."
    )
